                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="relative group">
                                ...
                                {/* Bottom gradient overlay to ensure button readability when text scrolls behind them */}
                                <div className="absolute inset-x-0 bottom-0 h-40 bg-gradient-to-t from-[#0a0a0b] via-[#0a0a0b]/80 to-transparent rounded-b-[2rem] pointer-events-none z-10" />
                        ...
                        <div className="flex flex-col sm:flex-row gap-4">
                            ...
                            <Link
                                href="/dashboard"
                                className="flex-1 h-16 rounded-[2rem] bg-white/5 border border-white/10 text-white font-black text-xs uppercase tracking-[0.2em] transition-all hover:bg-white/10 flex items-center justify-center gap-3"
                            >
                                <X className="w-5 h-5" />
                                Cancel Analysis
                            </Link>
