...
export default async function AccountPage() {
    ...
    return (
        <div className="p-8 max-w-3xl">
            ...
            {/* Profile card */}
            <section className="rounded-xl p-6 mb-5" style={{ background: '#111113', border: '1px solid rgba(255,255,255,0.06)' }}>
            ...
            {/* Danger zone */}
            <section className="rounded-xl p-6" style={{ background: '#111113', border: '1px solid rgba(239,68,68,0.15)' }}>
