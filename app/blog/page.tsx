    ...
    return (
        <div className="min-h-screen" style={{ background: '#080808' }}>
            ...
            <section className="max-w-6xl mx-auto px-6 md:px-12 mb-16 relative z-10">
                <FadeIn delay={0.1}>
                    <div className="rounded-[2.5rem] relative overflow-hidden bg-black/40 border border-indigo-500/20 shadow-[0_0_30px_rgba(99,102,241,0.05)] group">
                        <div className="grid md:grid-cols-2 gap-0">
                            {/* Featured Image */}
                            <div className="w-full h-64 md:h-full min-h-[300px] bg-black/40 relative overflow-hidden">
                            ...
                            <div className="p-8 md:p-12 relative z-10 flex flex-col justify-center">
                                <span className="w-fit inline-block text-[9px] font-bold text-indigo-400 uppercase tracking-widest border border-indigo-500/20 rounded-full px-3 py-1 mb-6 bg-indigo-500/10">
                                    Featured · {posts[0].category}
                                </span>
                                <h2 className="font-display text-3xl md:text-5xl font-bold text-white mb-6 leading-tight group-hover:text-indigo-300 transition-colors">{posts[0].title}</h2>
                                <p className="text-slate-400 text-lg leading-relaxed mb-8 max-w-xl">{posts[0].excerpt}</p>
            ...
            <section className="max-w-6xl mx-auto px-6 md:px-12 pb-28 relative z-10 flex flex-col lg:flex-row gap-12">
                ...
                <div className="lg:w-2/3">
                    ...
                    <div className="mt-16 text-center border-t pt-10" style={{ borderColor: 'rgba(255,255,255,0.05)' }}>
                        <button className="inline-flex text-white px-8 py-4 rounded-full font-bold text-[10px] uppercase tracking-widest hover:scale-[1.05] transition-all bg-white/5 hover:bg-white/10 border border-white/10 hover:border-white/20">
                            Load More Articles
                        </button>
                    </div>
                </div>
